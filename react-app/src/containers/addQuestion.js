    ...
    render(){
        ...
        { 
            ...
            <form className="Form">
                ...
                <hr />
                <button onClick={this.sendQuestion} className="btn btn-success"> {this.props.mode==="add" ? "Add" : "Edit" } Question !</button>
        ...
        if(this.state.submitted)
        {
            ...
            if(this.props.mode==="edit")
            q  = (<Redirect to={"/viewQuizzes/view/"+this.props.genre +'/'+this.props.quizid}/>)    
            else
            q = (<Redirect to={"/viewQuizzes/view/"+this.props.genre+'/'+this.props.id} />)
        }
        return(
            <div className="Form">
                {q}
